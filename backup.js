...
window.addEventListener("load", (event) => {
  ...
  const SONGS = [
    ...
    {
      url: "./sounds/XX_OUTRO/OUTRO1withNAMES.mp3",
      tags: ["outro"],
    },
    ...
    {
      url: "./sounds/XX_OUTRO/OUTRO2withNAMES.mp3",
      tags: ["outro"],
    },

    {
      url: "./sounds/XX_OUTRO/OUTROMUSICONLYLONG.mp3",
      tags: ["intro"],
    },
    {
    ...
    {
      url: "./sounds/MUSIC/M_KIKO_B_05.mp3",
      tags: ["music"],
    },
    {
      url: "./sounds/MUSIC/M_KIKO_B_06.mp3",
      tags: ["music"],
    },
    {
