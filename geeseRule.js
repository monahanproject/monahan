// not currently using, just bumping the geese to the front if one appears

// import { logRuleApplication } from './playlistBuilder.js';

//   // R25. The tracklist must not contain one goose track. 0 is acceptable, or 2 or more is acceptable
// let geeseTracks;
